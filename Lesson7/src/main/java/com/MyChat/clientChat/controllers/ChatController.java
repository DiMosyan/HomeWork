...
public class ChatController {
    ...
    private String updateUserListMessageBuilder(String name, UserListUpdateCommandData.UserListUpdateType dataType) {
        StringBuilder strBuilder = new StringBuilder(DateFormat.getDateInstance().format(new Date()))
        ...
        strBuilder.append(System.lineSeparator()).append(System.lineSeparator());
    ...
    public void sendMessage(ActionEvent actionEvent) {
        ...
        String localMessage = String.format("%s%sI: %s%s%s", DateFormat.getDateInstance().format(new Date()),
    ...
    private void updateMessage(String nameOfChat, String sender, String message) {
        String localMessage = String.format("%s%s%s: %s%s%s", DateFormat.getDateInstance().format((new Date())),
                System.lineSeparator(), sender, message, System.lineSeparator(), System.lineSeparator());
        ...
        if (userList.getSelectionModel().getSelectedItem() != null && userList.getSelectionModel().getSelectedItem().equals(nameOfChat)) {
            ...
            Platform.runLater(() -> userList.getItems().set(userList.getItems().indexOf(sender), sender + "*"));
        }
    }
    ...
    private void changeNick(Command command) {
        ...
        Platform.runLater(() -> {
            if (data.getOldNick().equals(name)) {
                ...
                updateMessage(data.getOldNick(), data.getOldNick(), String.format("renamed to %s", data.getNewNick()));
